...
{
    public class DecrypteModel
    {
        public static string Text { get; set; }
        public static void Decrypte(string messageDF, string keyDF)
        {
            ...
            char[] message = messageDF.ToLower().ToCharArray();
            char[] key = keyDF.ToLower().ToCharArray();
